...
dotnet
{
    ...
    assembly("Microsoft.Dynamics.Nav.AzureKeyVaultClient")
    {
        ...
        type("Microsoft.Dynamics.Nav.AzureKeyVaultClient.AzureKeyVaultAppSecretProvider"; "AzureKeyVaultAppSecretProvider")
        {
        }
    }
    ...
    assembly("Microsoft.Dynamics.Nav.Ncl")
    {
        type(Microsoft.Dynamics.Nav.Runtime.NavTestExecution; NavTestExecution)
        {
        }
    }
    assembly("Microsoft.Dynamics.Nav.ClientExtensions")
